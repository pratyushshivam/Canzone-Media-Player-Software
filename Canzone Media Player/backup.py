...
def about_us():
    tkinter.messagebox.showinfo('About Canzone', 'This is a free Music Player Software developed by Pratyush Shivam (@pratyushshivam)')
...
subMenu.add_command(label="Contact Us", command=about_us)
